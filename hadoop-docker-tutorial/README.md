...
├── README.md
├── docker-compose.yml
└── result.txt    --- Arquivo final gerado pelo WordCount
```
...
Todas as evidências estao disponíveis na pasta >> [hadoop-docker-tutorial/images](https://github.com/flg29-data/LAB_GrupoA_EcossistemadeBigData/tree/04279aef80f2698a832e7569d29a12e7fce20219/hadoop-docker-tutorial/images)
